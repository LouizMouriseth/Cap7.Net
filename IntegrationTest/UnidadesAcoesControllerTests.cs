...
public class UnidadesAcoesControllerTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly HttpClient _client;

    public UnidadesAcoesControllerTests(WebApplicationFactory<Program> factory)
    {
